  ...
  <div class="detail_wrap">
    <el-form :model="detailRuleForm"
      ...
      <el-form-item label="文章名称"
                    prop="articleTitle">
        <el-input v-model="detailRuleForm.articleTitle"></el-input>
      </el-form-item>
      <el-form-item label="副标题"
                    prop="subTitle">
        <el-input v-model="detailRuleForm.subTitle"></el-input>
      </el-form-item>

      <el-form-item label="来源"
                    prop="articleFrom">
        <el-select v-model="detailRuleForm.articleFrom"
                   @change="chooseFrom">
          <el-option label="校内小记者"
        ...
        <!-- <el-radio-group v-model="detailRuleForm.articleFrom">
          <el-radio :label="1">校内小记者</el-radio>
          <el-radio :label="2">本校</el-radio>
          <el-radio :label="3">转载</el-radio>
        </el-radio-group> -->
      </el-form-item>
      <template v-if="detailRuleForm.articleFrom===1">
        <el-form-item label="小记者"
                      prop="repoterId">
          <!-- <el-input v-model="detailRuleForm.repoterId"></el-input> -->
          <el-select v-model="detailRuleForm.repoterId">
            <el-option v-for="item in reporterIdList"
                       :key="item.id"
                       :value="item.id"
                       :label="item.repoterName"
                       :checked="item.checked"></el-option>
          </el-select>
        </el-form-item>
      </template>
      <template v-else-if="detailRuleForm.articleFrom===2">
        <el-form-item label="作者"
                      prop="author">
          <el-input v-model="detailRuleForm.author"></el-input>
        </el-form-item>
        <!-- <el-form-item v-if="detailRuleForm.articleFrom===3" label="转自"
                      prop="reprintFrom"
                      hide-required-asterisk="false">
          <el-input v-model="detailRuleForm.reprintFrom"></el-input>
        </el-form-item> -->
      </template>

      <template v-else-if="detailRuleForm.articleFrom===3">
      ...
      <el-form-item label="摘要"
        ...
        <el-input type="textarea"
                  :rows="4"
                  v-model="detailRuleForm.summary"></el-input>
      </el-form-item>
      <el-form-item label="相关话题"
                    prop="articleTopic">
        <el-input v-model="detailRuleForm.articleTopic"></el-input>
      </el-form-item>
      ...
      <el-form-item label="关键词"
                    prop="keyWords"
                    hide-required-asterisk="false">
        <el-input v-model="detailRuleForm.keyWords"></el-input>
      </el-form-item>
      ...
      <el-form-item label="内容"
                    prop="content"
                    class="ueditor_wrap">
        <vue-ueditor-wrap v-model="detailRuleForm.content"
                          :destroy="true"
                          ref="editor"
                          mode="observer"
...
export default {
  ...
  methods: {
    ...
    chooseFrom () {
      if (this.detailRuleForm.articleFrom === 1) {
        console.log(this.detailRuleForm.articleFrom)
        this.getReporterList()
    ...
    //获取小记者下拉列表 
    getReporterList () {
      optConService.getReporterList(this.detailRuleForm.schoolId, -1).then((result) => {
        // console.log("result:---", result)
        if (result.retCode === '00000') {
          this.reporterIdList = result.voList
        } else {
          this.$message({
            message: result.retInfo || '获取小记者列表失败，请重试',
            type: 'error',
            onClose: () => {
              this.loading = false
            }
    ...
    onUploadChange (file) {
      ...
      reader.onload = function(e){
          ...
          this.detailRuleForm.coverImg = this.result
      } */
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          const articleDetailForm = {
            ...
            articleType: 1,
            articleFrom: this.detailRuleForm.articleFrom,
            repoterId: this.detailRuleForm.repoterId,
            ...
            optConService.addEditArticle(articleDetailForm).then((result) => {
              ...
              if (result.retCode === '00000') {
                this.$message({
                  ...
                  type: 'success',
                  onClose: () => {
                    this.$router.push({ path: '/school/content/list' })
                  }
                })
              } else {
                this.$message({
